...
import weichun.campus.ActivityMain;
import weichun.campus.R;
import weichun.campus.library.Fragment1;
import weichun.campus.library.Fragment2;
import weichun.campus.library.Fragment3;
...
public class ActivityLibraryBottom extends FragmentActivity
{
		...
		private void initView() {
			...
			{				
				...
				public void onClick(View arg0)
				{
					...
					finish();
					startActivity(new Intent(ActivityLibraryBottom.this, ActivityMain.class));
				}
			});
